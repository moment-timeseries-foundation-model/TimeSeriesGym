...
from timeseriesgym.utils import get_logger, get_timestamp
...
def parse_container_config(raw_config: dict) -> dict:
    ...
    if "gpus" in raw_config and raw_config["gpus"] != "":
        device_ids = raw_config["gpus"].split(",")
...
def reconcile_args(config_args: str | None = None, dict_args: dict | None = None) -> dict:
    """
...
def create_competition_container(
    ...
    volumes_config: dict,
    env_vars: dict,
    container_image: str = "timeseriesgym-env",
